...
Ext.define('Ext.ux.DateTimePicker', {
    ...
    initComponent: function() {
        ...
        me.secondSlider = new Ext.slider.Single({
            fieldLabel: me.secondText,
            labelAlign: 'top',
            labelSeparator: ' ',
            padding: '0 10 10 0',
            focusable : false,
    ...
    afterRender: function() {
        ...
        me.timePicker = Ext.create('Ext.panel.Panel', {
            ...
            items: [me.hourSlider, me.minuteSlider, me.secondSlider]
        });
    ...
    changeTimeValue: function(slider, e, eOpts) {
        var me = this,
            ...
            secondPrefix = me.secondSlider.getValue() < 10 ? '0' : '',
            timeSufix = '',
        ...
        label.setText(hourPrefix + hourDisplay + ':' + minutePrefix + me.minuteSlider.getValue()  + ':' + secondPrefix + me.secondSlider.getValue() + timeSufix);
    ...
    handleDateClick: function(e, t, /*private*/ blockStopEvent) {
        var me = this,
            ...
            secondSet = me.timePicker.items.items[2].getValue(),

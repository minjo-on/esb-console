    ...
    onMouseDrag:function(canvas, dx, dy, dx2, dy2)
    {
    	if( !((this.mouseDraggingElement instanceof draw2d.ResizeHandle) || (this.mouseDraggingElement instanceof draw2d.Port))){
	    	if(this.cloneOnDrag ===true && this.mouseDraggingElement !==null){
	    		...
	    		// user date id set
	    		var userdata = this.mouseDraggingElement.getUserData();
	    		var routeId = userdata.componentType+"_"+getComponentSeq(userdata.componentType);
	    		userdata.id = routeId;
	    		
	    		this.mouseDraggingElement.setRouteId(routeId);
